...
class Javascript implements SubscriberInterface
{
    ...
    {
        $jsFiles = [
            __DIR__ . '/../Views/responsive/frontend/_resources/javascript/fatchipCTAmazon.js',
            __DIR__ . '/../Views/responsive/frontend/_resources/javascript/fatchipCTPaypalExpress.js',
        ];
